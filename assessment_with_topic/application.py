...
def ackaud():
    ...
    def generate_response(whisper_result, wav_buffer, referenceText, topic):
    # Send transcript immediately
        ...
        ielts_band_score = get_ielts_band_score(pronunScore, referenceText, topic)
    ...
    return Response(
        stream_with_context(generate_response(whisper_result, wav_buffer, referenceText,topic)),
...
def get_ielts_band_score(pronunScore, referenceText, topic):
    ...
    user_message = f"""
    I need you to evaluate the IELTS band score for the whole speech based on the topic-{topic} grammar and lexical resources
